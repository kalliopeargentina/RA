...
<span style="color: red;">Están normalmente distribuidos porque el test fasllo en rechazar la hipótesis nula de que no están normalmente distribuidos</Span>
...
bptest(model)
```
<span style="color: red;">Concluimos que se rechaza homocedasticidad</span>
